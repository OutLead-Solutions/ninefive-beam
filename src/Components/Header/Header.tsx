...
export const Header = () => {
  ...
  return (
    <div>
      <div
        className={`
                    container-fluid text-white d-none d-lg-block slow-transition overflow-x-0
                    ${
                      path === "/"
                        ? !scrolled
                          ? "p-3 transparencyBG05 fixed-top"
                          : "p-1 shadow-lg fixed-top blueBG05"
                        : !scrolled
                        ? "p-3 shadow blueBG"
                        : "p-1 shadow-lg fixed-top blueBG05"
                    }
      ...
      <div className="container-fluid p-2 blueBG text-white d-block d-lg-none">
        <div className="row">
          <div className="col-9 text-center">
            <img src={logo} alt="" className="img-thumbnail border-0 w-100" />
          </div>
          <div className="col-3">
            <div className="h-100 d-inline-block align-middle"></div>
            <Button
