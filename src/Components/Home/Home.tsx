...
export const Features = () => {
  return (
    <>
      <h2 className="text-center blueText fw-bolder letter-spacing2 mt-5 pt-3">
        Why Choose NineFive BIM?
      </h2>
      <div className="features-section row mt-5 p-3 p-lg-5 pb-0">
        <img
          src={`/images/services/pc-image.png`}
          alt=""
...
export const ServiceDescription = () => {
  ...
  return (
    <div className="row p-3 p-lg-5">
      <h2 className="text-center col-12 blueText mb-5 fw-bolder letter-spacing2">
        What We Provide?
      </h2>
...
export const AllServices = () => {
  return (
    <div className="container-fluid mt-5 mb-5">
      <h2 className="text-center col-12 blueText mt-5 mb-5 fw-bolder letter-spacing2">
        Our Services
      </h2>
      <div className="row">
